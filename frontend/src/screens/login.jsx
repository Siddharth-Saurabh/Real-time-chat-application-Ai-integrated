...
import axios from '../config/axios'; // ensure this is correctly set up
import { UserContext } from '../context/user.context'; // adjust the import path as necessary}
...
const Login = () => {
  ...
  axios.post('/users/login', { email, password })
    .then((res) => {
      ...
      // ✅ set both user info and token in context
      setUser({
        ...res.data.user,
      ...
      <div className="w-full max-w-md bg-gray-800/90 rounded-2xl shadow-2xl p-10 border border-gray-700">
        ...
        >
          <svg className="w-5 h-5" viewBox="0 0 48 48">
            <g>
              <path fill="#4285F4" d="M44.5 20H24v8.5h11.7C34.6 33.1 29.8 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.1 8.1 2.9l6.1-6.1C34.5 6.5 29.6 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20c11 0 19.7-8 19.7-20 0-1.3-.1-2.7-.2-4z"/>
              <path fill="#34A853" d="M6.3 14.7l7 5.1C15.5 16.2 19.4 13 24 13c3.1 0 5.9 1.1 8.1 2.9l6.1-6.1C34.5 6.5 29.6 4 24 4c-7.7 0-14.3 4.3-17.7 10.7z"/>
              <path fill="#FBBC05" d="M24 44c5.6 0 10.5-1.9 14.3-5.2l-6.6-5.4C29.8 36 24 36 24 36c-5.8 0-10.6-2.9-13.7-7.2l-7 5.1C9.7 41.7 16.3 44 24 44z"/>
              <path fill="#EA4335" d="M44.5 20H24v8.5h11.7C34.6 33.1 29.8 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.1 8.1 2.9l6.1-6.1C34.5 6.5 29.6 4 24 4c-7.7 0-14.3 4.3-17.7 10.7z" opacity=".3"/>
            </g>
          </svg>
